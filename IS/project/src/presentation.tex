...
\begin{document}
    ...
    \frame{
        ...
        \begin{itemize}
            \setlength\itemsep{1em}
            \item Auswahl von Neuronen über die "`Eignung"' (Distanzfunktion)
            \item Abstand zwischen Eingabevektoren und Gewichtvektoren wird bestimmt
            \item Zufällige Auswahl bei gleicher Diszanz
    ...
    \frametitle{Thema}
        \begin{definition}{Verarbeitung mobiler Sensordaten}
            \begin{itemize}
                ...
                \item Kontinuierliche Erfassung physiologischer und funktionellen Daten
    ...
    \frame{
        ...
        \begin{itemize}
            \setlength\itemsep{1em}
            \item \textit{Deep Learning} ist zur Zeit sehr erfolgreich bei Implamentationen, die
